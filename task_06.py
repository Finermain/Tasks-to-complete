        ...
        for i, player in enumerate(mas):
            ...
            if i == 1:
                ...
                if player not in ['P', 'S', 'R']:
                    raise NoSuchStrategyError #Выведет ошибку в основном блоке исключений
...
def exception_players(values):
        ...
        if len(values) != 2:
            raise WrongNumberOfPlayersError #Выведет ошибку в основном блоке исключений
...
def rps_game_winner(values):
        ...
        #Блок исключения 
            ...
            raise e #Теперь оно выводит не текст вызваной ошибки,а вызванную ошибку
